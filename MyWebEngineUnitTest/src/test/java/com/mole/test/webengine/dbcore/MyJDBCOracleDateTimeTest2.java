...
public class MyJDBCOracleDateTimeTest2 {
...
//					System.out.println("(java.sql.Timestamp)o = " + tt1.toString());
				...
				if(!rsm.getColumnClassName(column).equals("oracle.sql.TIMESTAMPLTZ")){
					...
					Timestamp  tt2 = rs.getTimestamp(column);
