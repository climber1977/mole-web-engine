...
<html lang="en">
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <lc:portal jsonDesc="example/chart_curve.json"></lc:portal>
        <lc:portal jsonDesc="example/chart_pie.json"></lc:portal>
        <lc:portal jsonDesc="example/chart_column1.json"></lc:portal>
        <lc:portal jsonDesc="example/chart_column2.json"></lc:portal>
        <lc:portal jsonDesc="example/chart_bar.json"></lc:portal>
    </body>
