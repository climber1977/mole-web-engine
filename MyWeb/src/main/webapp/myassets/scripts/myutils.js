...
function openWindow(requesturl, wh, hg,callback) {
	...
	if(window.showModalDialog){ 
		...
		var params = "status:false;dialogWidth:"+wh+"px;dialogHeight:"+hg+"px;scrollbar=no;help: no;;status:no;";
...
{
	return getQueryStringFromUrl(window.location.search.substr(1), name);
}
